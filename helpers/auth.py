...
<div style="display: flex; justify-content: left;">
    <a href="{authorization_url}" onclick="window.top.location.href=this.href; return false;" style="background-color: #fff; color: #000; text-decoration: none; text-align: center; font-size: 16px; margin: 4px 2px; cursor: pointer; padding: 8px 12px; border-radius: 4px; display: flex; align-items: center;">
